...
From the plot we can see that as beta1 true value increases, the proportion of rejecting the nulls increases. This means that as effect size increases, power of the test increases. (Effect size is equal to $\frac{beta1 - 0}{sd}$")
